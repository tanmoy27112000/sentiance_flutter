...
class SentianceFlutter {
  static const MethodChannel _channel = const MethodChannel('sentiance_flutter');
  static const MethodChannel _channel1 = const MethodChannel('flutter.sentiance/helper');
