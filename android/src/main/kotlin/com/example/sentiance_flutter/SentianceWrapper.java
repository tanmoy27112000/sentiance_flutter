...
//    }
//
//    private void listenTripstatus() {
//        final TripProfileListener mTripProfileListener = new TripProfileListener() {
//            @Override
...
//                        .post(RequestBody.create(MediaType.parse("application/json"), String.valueOf(tripProfile)))
//                        .build();
//
//
...
//        };
//
//        boolean isTripOngoing = Sentiance.getInstance(mContext).isTripOngoing(ANY);
//
//        if(isTripOngoing){
//            Sentiance.getInstance(mContext).setTripProfileListener(mTripProfileListener);
//        }
//
//    }
//
...
////
////                Log.i(TAG, "Crash event captured " + crashEvent);
////
...
////                        .add("crash_alert", "true")
////                        .build();
////
////                Log.i(TAG, "lat " + Double.toString(location.getLatitude()) + "lnnnn" + Double.toString(location.getLongitude()));
////
////                OkHttpClient client = new OkHttpClient();
////
////                Request request1 = new Request.Builder()
////                        .url(CRASH_DETECTION_URL)
////                        .header("Authorization", getAuthHeader())
////                        .post(formBody)
////                        .build();
////
...
////                    @Override
////                    public void onResponse(Call call, Response response) throws IOException {
////                        Log.w("res crash", response.body().string());
////
////                    }
////
////                });
